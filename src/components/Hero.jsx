...
const Hero = () => {
  return (
    <div className="bg-black pt-36 pb-44 px-20 font-custom2 h-98 flex justify-center items-center">
      <p className="w-[80%] font-custom2 text-[62px] text-white leading-normal tracking-normal">
