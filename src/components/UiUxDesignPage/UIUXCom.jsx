  ...
  return (
    <div className="main bg-black md:flex md:justify-center md:items-center md:flex-col">
      ...
      <div className="photos bg-black columns-1 py-8 px-4 md:columns-1 lg:columns-2 space-y-6 gap-6 md:py-12">
        <img alt="SampleImage" src={UIUX_1} className="md:h-[450px] md:w-[450px] object-cover"/>
        <img alt="SampleImage" src={UIUX_6} className="md:h-[550px] md:w-[450px] object-cover"/>
        <img alt="SampleImage" src={UIUX_5} className="md:h-[450px] md:w-[450px] object-cover"/>
        <img alt="SampleImage" src={UIUX_2} className="md:h-[450px] md:w-[450px] object-cover"/>
        <img alt="SampleImage" src={UIUX_4} className="md:h-[450px] md:w-[450px] object-cover"/>
        <img alt="SampleImage" src={UIUX_3} className="md:h-[550px] md:w-[450px] object-cover"/>
      </div>
    </div>
  );
};
