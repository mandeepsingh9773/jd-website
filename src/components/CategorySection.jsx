      ...
      <div className="image_card1 flex flex-col md:w-[290px]">
        ...
        <div className="image_card2 flex flex-col md:w-[290px]">
          <img
            ...
            alt="category"
          />
          <p className="text-white pt-2 md:text-[25px] md:text-left md:pt-2">Backdrops</p>
        ...
        <div className="image_card5 flex flex-col md:w-[290px]">
          <img
            ...
            alt="category"
          />
          <p className="text-white pt-2 md:text-[25px] md:text-left md:pt-2">Custom Frames</p>
          <p className="text-[#8B8B8B] md:text-[20px] md:text-left">
            Home Decor, Frames
          </p>
        </div>
