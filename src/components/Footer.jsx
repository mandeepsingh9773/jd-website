...
const Footer = () => {
  return (
    <div className="flex flex-col pl-8 gap-10 md:flex-row md:justify-center text-white bg-black md:space-x-4 font-custom1">
      ...
      <div className="flex flex-col md:flex md:flex-col md:gap-4 md:mt-3">
        <img className="hidden md:inline-block md:w-[16rem]" src={Line} alt="line" />
        <input className="w-1/2 md:w-auto p-1 mb-4 md:text-[18px] md:p-2 text-black" type="text" id="email" name="email" placeholder="Email" />
        <button className="w-1/2 md:w-auto p-1 bg-[#303030] text-[#A4A4A4] hover:bg-gray-800 md:p-2 md:text-[18px]">Subscribe</button>
      </div>
    </div>
